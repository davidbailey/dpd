...
class TransportationAlternative:
    def __init__(self, route, vehicle, zones, dwell_time, start, end, freq):
        ...
        self.schedule_reversed = Schedule.from_trip(
            self.trip_reversed, start, end, freq
        )
    ...
    def plot_schedule(self, ax):
        ...
        self.schedule.trips[list(self.schedule.trips.keys())[0]].plot_schedule(
            ax=ax
        )  # to add labels
