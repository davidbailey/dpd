...
KinematicBodyDataCollector = DataCollector(agent_reporters=kinematic_body_agent_reporters)

kinematic_body_with_acceleration_agent_reporters = kinematic_body_agent_reporters | {"acceleration": "acceleration"}
KinematicBodyWithAccelerationDataCollector = DataCollector(agent_reporters=kinematic_body_with_acceleration_agent_reporters)
